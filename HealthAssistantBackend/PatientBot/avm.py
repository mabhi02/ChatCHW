...
Return ONLY the option number (e.g., "2")."""
    ...
    def run_chw_workflow(self, patient_info=None):
        """Run the EXACT ChatCHW workflow - FULLY AUTOMATED and return results"""
...
def main(case_id):
    ...
    # Run CHW workflow and return results
    return runner.run_chw_workflow(patient_info)

if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python avm.py <case_id>")
        sys.exit(1)
